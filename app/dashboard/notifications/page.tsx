...
export default function AdminNotificationsPage() {
  ...
  const totalPages = Math.ceil(userNotifications.length / itemsPerPage)
  const startIndex = (currentPage - 1) * itemsPerPage
  const paginatedNotifications = userNotifications.slice(startIndex, startIndex + itemsPerPage)
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{notifications.filter((n:any) => !n.read).length}</p>
              </div>
            ...
            <CardContent className="p-0">
              ...
              <div className="flex items-center justify-between p-4 border-t bg-gray-50">
                <div className="text-sm text-gray-600">
                  Showing {startIndex + 1} to {Math.min(startIndex + itemsPerPage, userNotifications.length)} of{" "}
