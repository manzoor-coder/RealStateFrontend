...
import { FiX, FiSave, FiUser, FiFileText, FiAward } from "react-icons/fi"
...
export default function EditAgentModal({ agent, open, onOpenChange }: EditAgentModalProps) {
  ...
  useEffect(() => {
    if (agent) {
      setFormData({
        ...
        projectCount: agent.projectCount?.toString() || "",
        discountRate: agent.discountRate?.toString() || "",
        specializations: agent.specializations || [],
        address: {
          street: agent.user.address?.street || "",
          city: agent.user.address?.city || "",
          state: agent.user.address?.state || "",
          country: agent.user.address?.country || "",
          zipCode: agent.user.address?.zipCode || "",
        },
      })
    }
  }, [agent])
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-lg border border-green-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="projectCount" className="text-sm font-medium text-gray-700">
                  Project Count
                </Label>
                <Input
                  id="projectCount"
